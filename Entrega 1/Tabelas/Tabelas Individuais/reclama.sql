CREATE TABLE Reclama( -- relacionamento triplo
    ...
    pedido_id VARCHAR2(255) NOT NULL,
    ...
    CONSTRAINT reclama_fk1 FOREIGN KEY (cliente_cpf) REFERENCES Cliente(cpf),
    CONSTRAINT reclama_fk2 FOREIGN KEY (pedido_id) REFERENCES Pedido(ID_do_pedido),
    CONSTRAINT reclama_fk3 FOREIGN KEY (funcionario_cpf) REFERENCES Funcionario(cpf)
);
